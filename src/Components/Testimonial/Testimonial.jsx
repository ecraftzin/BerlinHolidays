...
const Testimonial = () => {
  ...
  return (
    <section className="bg-[url('/images/home-1/tesimonialbg.jpeg')] bg-[rgba(30,30,30,0.4)] dark:bg-[rgba(30,30,30,0.6)] bg-opacity-40 grid items-center justify-center bg-no-repeat bg-cover">
          ...
          <div className="keen-slider__slide number-slide1 hidden sm:block">
            ...
            >
              <div className="bg-white dark:bg-normalBlack p-5 md:p-10 relative before:absolute before:w-[85%]  before:h-[10px] before:bg-khaki before:mx-auto before:-top-[10px] before:left-0 before:right-0 after:absolute after:w-[85%] after:h-[10px] after:bg-khaki after:mx-auto after:-bottom-[10px] after:left-0 after:right-0 hidden sm:block">
                ...
                <p className="font-Lora text-sm sm:text-base leading-[26px] text-gray dark:text-lightGray font-normal xl:text-lg mt-[30px] italic mb-[45px] before:absolute before:h-[30px] before:left-0 before:bottom-[-36px] before:bg-khaki before:w-[1px] relative">
                  “Our stay at the resort was pure bliss! The staff went 
                  above and beyond to make us feel at home. The view from
                   our villa, surrounded by misty hills and coffee plantations, 
                   was breathtaking. Truly the best escape from city life.”
                </p>
                <span className="w-[1px] h-[25px] bg-[#ddd]"></span>
          ...
          <div className="keen-slider__slide number-slide1 hidden sm:block">
            ...
            >
              <div className="bg-white dark:bg-normalBlack p-5 md:p-10 relative before:absolute before:w-[85%]  before:h-[10px] before:bg-khaki before:mx-auto before:-top-[10px] before:left-0 before:right-0 after:absolute after:w-[85%] after:h-[10px] after:bg-khaki after:mx-auto after:-bottom-[10px] after:left-0 after:right-0 hidden sm:block">
                ...
                <p className="font-Lora text-sm sm:text-base leading-[26px] text-gray dark:text-lightGray font-normal xl:text-lg mt-[30px] italic mb-[45px] before:absolute before:h-[30px] before:left-0 before:bottom-[-36px] before:bg-khaki before:w-[1px] relative">
                  “A perfect romantic getaway! The candlelight dinner by 
                  the pool and the soothing spa session made our anniversary
                   unforgettable. The team’s attention to detail and warmth
              ...
              <div className="bg-white dark:bg-normalBlack p-5 md:p-10 relative before:absolute before:w-[85%]  before:h-[10px] before:bg-khaki before:mx-auto before:-top-[10px] before:left-0 before:right-0 after:absolute after:w-[85%] after:h-[10px] after:bg-khaki after:mx-auto after:-bottom-[10px] after:left-0 after:right-0 hidden sm:block">
                ...
                <p className="font-Lora text-sm sm:text-base leading-[26px] text-gray dark:text-lightGray font-normal xl:text-lg mt-[30px] italic mb-[45px] before:absolute before:h-[30px] before:left-0 before:bottom-[-36px] before:bg-khaki before:w-[1px] relative">
                  “One of the most peaceful resorts I’ve ever visited.
                   ...
                   The food, especially the Kerala-style breakfast, was delicious.
                    I’ll definitely be coming back with my family.”
                </p>
                <span className="w-[1px] h-[25px] bg-[#ddd]"></span>
