...
const Testimonial = () => {
  ...
  return (
    <section className="bg-[url('/images/home-1/tesimonialbg.png')] bg-[rgba(30,30,30,0.4)] dark:bg-[rgba(30,30,30,0.6)] bg-opacity-40 grid items-center justify-center bg-no-repeat bg-cover">
