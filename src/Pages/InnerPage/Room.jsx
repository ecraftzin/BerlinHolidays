    ...
    <section className="">
      ...
      <div className="bg-whiteSmoke dark:bg-lightBlack py-20 2xl:py-[120px]">
        <div className="Container ">
          ...
          {loading ? (
            <div className="mt-14 2xl:mt-[60px] text-center">
                ...
                >
                  <div className="relative">
                    <div className="overflow-hidden">
                      <img
                        src={room.images && room.images.length > 0 ? room.images[0] : "/images/inner/roms-1.jpg"}
                        className="w-full h-full object-cover group-hover:scale-110 transition-all duration-300"
                        alt={room.name}
                        onError={(e) => {
                          e.target.src = "/images/inner/roms-1.jpg";
                        }}
                      />
                    </div>
                    <div className="px-5 3xl:px-6 py-2 inline-flex bg-khaki text-sm items-center justify-center text-white absolute top-[10px] right-[10px]">
                      <span className="">₹{room.base_price}</span>
                      <span className="mx-2">|</span>
                      <span>Night</span>
                    </div>

                    <Link to={`/room_details/${room.slug}`} state={{ roomData: room }}>
                      ...
                      <div className="border-t-[1px] border-[#e8e8e8] dark:border-[#424242] py-5">
                        <div className="px-[30px] flex items-center justify-between">
                          ...
                          <ul className="flex items-center text-khaki space-x-[5px]">
                            {[...Array(room.star_rating || 5)].map((_, i) => (
                              <li key={i}>
                                <FaStar />
                              </li>
                            ))}
              ...
              <div className="bg-lightBlack  p-[30px] lg:p-[45px] 2xl:p-[61px]">
                ...
                <form className="grid items-center grid-cols-1 gap-2 mt-8" onSubmit={handleSubmit}>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full h-12 md:h-13 lg:h-[59px] px-4 border border-gray text-lightGray outline-none bg-lightBlack mt-4 focus:ring-0 focus:border-khaki focus:outline-none appearance-none cursor-pointer"
                    style={{
                  ...
                  <textarea
                    ...
                    cols="30"
                    rows="10"
                    className="w-full h-[121px] px-4 py-3 border border-gray text-white dark:text-lightGray outline-none bg-transparent mt-4 focus:ring-0 placeholder:text-gray resize-none focus:border-khaki focus:outline-none"
