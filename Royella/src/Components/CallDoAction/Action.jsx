        ...
        <div className=" w-full grid grid-cols-1 lg:grid-cols-2 items-center ">
          ...
          >
            ...
            <p className="text-sm sm:text-base font-Lora text-gray dark:text-lightGray font-normal leading-[26px]">
              Escape to a world where elegance meets tranquility.Our resort is 
              designed to offer an unforgettable experience — from lavish accommodations 
              and world-class dining to rejuvenating spa treatments and breathtaking views.
               Whether you’re here for a romantic getaway or a family retreat, every detail
                is crafted to provide comfort, privacy, and sophistication.
            </p>
          ...
          >
            <img
              src="/images/home-1/videothump.png"
